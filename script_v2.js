...
const levels = [
    // Level 0: Spring
    {
        theme: { backgroundColor: '#90EE90' }, // LightGreen
        platforms: [
    ...
    // Level 1: Summer
    {
        theme: { backgroundColor: '#FFFFE0' }, // LightYellow
        platforms: [
    ...
    // Level 2: Fall
    {
        theme: { backgroundColor: '#D2B48C' }, // Tan
        platforms: [
    ...
    // Level 3: Winter
    {
        theme: { backgroundColor: '#F0FFFF' }, // Azure
        platforms: [
    ...
    // Level 5: Night Scene
    {
        theme: { backgroundColor: '#000080', particles: 'stars' }, // Navy
        platforms: [
...
function loadLevel(levelIndex) {
    ...
    particles = [];
    if (level.theme.particles === 'rain') {
        for (let i = 0; i < 100; i++) {
            particles.push(new Particle(Math.random() * canvas.width, Math.random() * canvas.height, 2, 5, 'blue'));
        }
    } else if (level.theme.particles === 'stars') {
        for (let i = 0; i < 100; i++) {
            particles.push(new Particle(Math.random() * canvas.width, Math.random() * canvas.height, 2, 0.5, 'white'));
        }
    }
}
