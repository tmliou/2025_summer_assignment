...
const levels = [
    ...
    // Level 1: Summer
    {
        theme: { backgroundColor: '#FFFFE0', sun: true, clouds: true, birds: true }, // LightYellow
        platforms: [
    ...
    // Level 3: Winter
    {
        theme: { backgroundColor: '#F0FFFF', particles: 'snow' }, // Azure
        platforms: [
...
function loadLevel(levelIndex) {
    ...
    if (level.theme.birds) {
        birds.push(new Bird(200, 100, 10, 1));
        birds.push(new Bird(700, 150, 8, 0.8));
    }
}
